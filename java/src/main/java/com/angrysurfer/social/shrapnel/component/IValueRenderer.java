...
public interface IValueRenderer {
    ...
    boolean canRender(IFieldSpec field);

    String renderCalculatedValue(IFieldSpec field, Object value);

    default String render(IFieldSpec field, Boolean value) {
